...
<html lang="fr">
	...
	<body>
		...
		<ul class="nav flex-column bg-darkc  sidebar">
			<li class="nav-item">
				<a class="nav-link active text-white" href="#twitch-embed"><img src="../imgsrc/logo.svg" alt="Logo Unichamps Twitch" />
					<div id="texteSidebar">Twitch</div>
				</a>
			</li>
			<li class="nav-item ">
				<a class="nav-link text-white" href="#youtube-embed"><img src="../imgsrc/logo.svg" alt="Logo Unichamps Youtube"><span class="texte-sidebar">Youtube</span></a>
			</li>
			<!-- <li class="nav-item">
	...
	<li class="nav-item text-white">
		...
		<div id="stream">
			...
			<div id="youtube-embed">
				<iframe style="width:80%; height: 670px;" src="https://www.youtube.com/embed/oer_ChuwCIA" title="YouTube video player"  allow="autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
		</div>
	</body> 
</html>