...
<html lang="fr">
	...
	<body onload="document.getElementsByTagName('body')[0].style.display = 'block';" style="display:none;">
		...
		<li id="lili">
			<ul>
				<a href="https://dedale-games.eu/" target="_blank">Dedale Game</a>
			</ul>
			<ul>
				<a href="https://ateliersweetpea.fr" target="_blank">Atelier Sweetpea</a>
			</ul>
			<ul>
				<a href="https://seedyourlungs.github.io/Seed-your-lungs/" target="_blank">Seed your lungs</a>
			</ul>
			<ul>
				<a href="https://agencecreons.fr">Agence Créons</a>
			</ul>
			<ul>
				<a href="https://www.unidice.fr">Unidice</a>
			</ul>
		</li>
	</body>
</html>